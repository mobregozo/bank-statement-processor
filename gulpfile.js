...
const paths = {
    sass: ['app/**/*.scss', '!app/assets/lib/**/*.scss','!app/assets/css/main.scss'],
    css: ['app/assets/*.css','app/assets/main.scss'],
...
gulp.task('default', ['copy', 'copy-libs', 'sass', 'templatecache', 'ng_annotate', 'useref', 'imagemin', 'jshint', 'watch', 'connect', 'open']);